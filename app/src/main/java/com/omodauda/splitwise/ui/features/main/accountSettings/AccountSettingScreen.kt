...
fun AccountSettingScreen(
    ...
    var showChangePasswordModal by rememberSaveable { mutableStateOf(false) }
    // delete account
...
@Composable
private fun AccountSettingFooter(
    saveChanges: () ->Unit,
    fullName: String?,
    ...
    Column(
        modifier = modifier
            ...
            .padding(
                ...
                bottom = ScreenDimensions.verticalPadding + paddingBottom,
                start = Spacing.large,
                end = Spacing.large
            )
        ...
        AppTextButton(
            ...
            onClick = {saveChanges()},
            enabled = fullName !== editableFullName
        )
    }
}
